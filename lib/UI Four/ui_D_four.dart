            ...
            children: [
              Container(
                ...
                child:AppBar(
                  ...
                  centerTitle: true,
                  leading: InkWell(child: Icon(Icons.arrow_back),onTap: (){Navigator.of(context).pop();},),
                ),
              ),
              Padding(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("All the advanced features for scaling",style: TextStyle(color: Colors.grey,fontSize: 16),),
                        Text("your business",style: TextStyle(color: Colors.grey,fontSize: 16),),
